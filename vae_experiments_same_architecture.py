...
class VAE(object):
    ...
    def loss(self, x, weight=1.0, bits=0.0):
        ...
        logpx = - utils.bceloss(pi, x).sum(1)
        ...
        for e in range(epoch):            
            ...
            if e%1 == 0:      
                ...
                if loss_val < best_val:
                    ...
                    best_val = loss_val
                tb_logger.scalar_summary('train/elbo', LOSSES/float(counter), e)
...
tb_logger = Logger(log_dir=args.log_dir, name='')
